use {
    crate::state::{AdapterPosition, TemplateVaultState, VaultAuthorityPda},
...
pub struct Withdraw {
    ...
    #[account(
        mut,
        address = TemplateVaultState::seeds(),
...
impl Withdraw {
    pub fn handler(
        ...
        // NOTE: Protocol CPI withdrawal is called here before the token transfer.
        // For a real protocol, add invoke_signed with vault_authority PDA seeds.
        // See the Anchor-based Kamino adapter for a complete CPI example.
